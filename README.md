...
SystemLaundryNadhifJiddan is my personal repostory at the time I participated in the district level Student Competency Competition. This project is made using WindowsFormsApp , .NET & C# programming language.For the database I used Microsoft SQL Server
